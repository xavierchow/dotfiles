...
values."
  ...
  (setq-default
   ...
   ;; Set the frame title to file name
...
`dotspacemacs/user-config' first."
        ...
        ;; https://practicalli.github.io/spacemacs/improving-code/formatting/
           ...
           "Set your work proxy."
             (interactive)
               ...
               (setq url-proxy-services
                 ...
                 (setenv "http_proxy" "http://localhost:1087")
                 (setenv "https_proxy" "http://localhost:1087")
                 ;; Set git configuration to include proxy
                 (setq magit-git-global-arguments '("--no-pager" "--literal-pathspecs" "-c" "core.preloadindex=true" "-c" "log.showSignature=false" "-c" "http.proxy=localhost:1087")))
